            ...
            {!uuid || !id ? (
                ...
                <>
                    <CSSTransition timeout={150} classNames={'fade'} appear in>
                        <SubNavigation id={'SubNavigation'}>
                            ...
                            <div>
                                ...
                                <NavLink to={`/server/${match.params.id}/config`} exact>
                                    Config Editor
                                </NavLink>
                                <NavLink to={`/server/${match.params.id}/design`} exact>
                                    Server Design
                                </NavLink>
                                <NavLink to={`/server/${match.params.id}/players`} exact>
                                    Player Manager
                                </NavLink>
                    ...
                    <RouterSwitch>
                        ...
                        <Route path={`${match.path}/config`} exact>
                            <ConfigEditor />
                        </Route>
                        <Route path={`${match.path}/design`} exact>
                            <ServerDesignEditor />
                        </Route>
